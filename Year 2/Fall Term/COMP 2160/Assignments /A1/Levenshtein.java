public class Levenshtein
{
    ...
    // NOTE: this method uses varargs. (see: https://docs.oracle.com/javase/8/docs/technotes/guides/language/varargs.html)
    // **DO NOT** try to use varargs in C. In Java, varargs behave as an array. When translating to C,
    // use an array of integers here.
