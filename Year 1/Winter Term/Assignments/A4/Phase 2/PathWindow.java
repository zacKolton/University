...
public class PathWindow  extends JFrame { //JFrame means "window", in effect
   ...
   private static final int LABEL_INSET_X = 10;
   ...
   private static final String[] LABELS = {"Extend","Delete","Insert","Select","Move"};
   public static final int EXTEND = 0, DELETE = 1, INSERT = 2, SELECT = 3, MOVE = 4; 
   //The x coordinates of the dividing lines between buttons
   private static final int[] DIVIDERS = {0,95,190,285,380,475};
      ...
      public void mouseClicked(MouseEvent e){
         ...
         if(y>height-BUTTON_HEIGHTS){
           for(int i=0; i<LABELS.length; i++){
              ...
              if(x<DIVIDERS[i+1]){
                 mode = i; //If so, that's now the mode
                 break;
              }//if
           }//for
         }//if in button area
